...
export class ProjectsComponent implements OnInit {
  @ViewChildren(StudentProjectChartComponent) chartComponents: QueryList<StudentProjectChartComponent>;
  ...
  constructor(public readonly studentProjectService: StudentProjectService,
  ...
  ngOnInit(): void {
    ...
    this.studentProjectService.load(this.student.no);
    ...
    this._statService.getStudentProjectYears(this.student.no).pipe(
      tap(years => {
        this.yearOptions = years.sort((a, b) => b - a).map(year => ({ viewValue: `${year}년`, value: year }));
